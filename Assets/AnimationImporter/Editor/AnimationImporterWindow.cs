...
namespace AnimationImporter
{
    public class AnimationImporterWindow : EditorWindow
    {
        ...
        private AnimationImporter importer { get { return AnimationImporter.Instance; } }
        ...
        public void OnGUI()
        {
            ...
            else
            {
                ...
                GUILayout.Label("Aseprite has to be installed on this machine because the Importer calls Aseprite through the command line for creating images and getting animation data.",
                                _infoTextStyle);
            }
        }
